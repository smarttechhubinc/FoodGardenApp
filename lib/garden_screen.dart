...
class _GardenScreenState extends State<GardenScreen> with TickerProviderStateMixin {
  ...
  // REMOVED: _getGreeting, _getUserName, _getGreetingEmoji, _getMood
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        // REMOVED: floatingActionButton (_buildHarvestFAB)
  ...
  // REMOVED: _buildWelcomeMessage method entirely
  ...
  // REMOVED: _buildHarvestFAB method entirely
