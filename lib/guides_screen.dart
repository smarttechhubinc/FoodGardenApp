...
class _GuidesScreenState extends State<GuidesScreen> {
      ...
      builder: (context) => AlertDialog(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text(suggestion, style: const TextStyle(height: 1.5)),
              ),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF39AC86)),
  ...
  Future<String?> _uploadImage() async {
    ...
    try {
      ...
      if (result['success'] == true) return result['imageUrl'];
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
  ...
  Future<void> _postQuestion() async {
    if (_questionController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please enter a question'), backgroundColor: Colors.orange),
      );
      return;
    }
  ...
  Future<void> _postAnswer(String questionId, String answerText) async {
    try {
      final result = await _apiService.postAnswer(questionId: questionId, text: answerText);
      if (result['success'] == true && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
              ...
              child: Column(
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (value) {
                      setDialogState(() => _selectedCategory = value ?? 'Vegetables');
                    },
                        ...
                        if (_selectedImageBytes != null)
                          Padding(
                            ...
                            child: TextButton.icon(
                              ...
                              style: TextButton.styleFrom(foregroundColor: const Color(0xFF39AC86)),
                            ),
                          ),
                      ],
                    ),
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            Expanded(child: _buildCommunityFeed(isDarkMode)),
          ],
        ),
      ),
    );
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.menu, color: Color(0xFF39AC86), size: 20),
          ),
          const Text(
            'Garden Community',
  ...
  Widget _buildCommunityFeed(bool isDarkMode) {
    if (_isLoadingQuestions) {
      return const Center(child: CircularProgressIndicator(color: Color(0xFF39AC86)));
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return _buildPostCard(_filteredQuestions[index], isDarkMode);
      },
    );
  }
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                question.authorImage.isNotEmpty
                    ? CircleAvatar(radius: 20, backgroundImage: NetworkImage(question.authorImage))
                    : Container(
                        width: 40,
                        height: 40,
                        decoration: BoxDecoration(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            timeAgo,
                            style: const TextStyle(fontSize: 11, color: Color(0xFF5C8A7A)),
                          ),
                          const SizedBox(width: 8),
                          Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(fontSize: 13, color: Color(0xFF5C8A7A)),
                      ),
                    ],
                  ),
                ),
                  ...
                  Row(
                    children: [
                      widget.question.authorImage.isNotEmpty
                          ? CircleAvatar(
                              radius: 24,
                              backgroundImage: NetworkImage(widget.question.authorImage),
                            )
                          : Container(
                              width: 48,
                              height: 48,
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      answer['authorImage'] != null &&
                                              answer['authorImage'].isNotEmpty
                                          ? CircleAvatar(
                                              radius: 20,
                                              backgroundImage:
                                                  NetworkImage(answer['authorImage']),
                                            )
                                          : Container(
                                              width: 40,
                                              height: 40,
